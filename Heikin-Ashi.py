...
def AI(target, name, set_time):
    ...
    if(sell_target=="0"):
        ...
        if (Heikin_Ashi_result['low'][198]>Heikin_Ashi_result['low'][197] and Heikin_Ashi_result['low'][197]<Heikin_Ashi_result['low'][196]): #get_ma = 이평선 120, 60의 계산값
            krw = get_balance("KRW")
            if krw > 5000:
    ...
    elif (Heikin_Ashi_result['low'][198]<Heikin_Ashi_result['low'][197]):
