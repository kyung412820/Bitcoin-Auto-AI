...
#바이낸스
access_b = "JB9ROiDejkH68stehWw8WhIMHixZy69Sx6rNw7SVJFUJFwfObL2QWAaDpmL99TZt"
secret_b = "nA1kbdjBiDKUZqznsYvrumM5sp9BqqARli1s2HykqQbY4Qw5qlasjfkMi1oaP6An"
...
def AI(target, name, set_time):
    ...
    if (ADX_result=="매수"and macd_current=="매수" and get_ma(df, 60, 120)=="up"): #get_ma = 이평선 120, 60의 계산값
        krw = get_balance("KRW")
        if krw > 5000:
